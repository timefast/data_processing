...
wd_result.replace(np.nan,9999).to_csv(datetime.now().strftime('%m-%d-%H-%M-%S') +'xiugai_alltime_wd.txt',sep = ' ')    
wendingdu_result.replace(np.nan,9999).to_csv(datetime.now().strftime('%m-%d-%H-%M-%S') +'xiugai_alltime_wendingdu.txt',sep = ' ')
