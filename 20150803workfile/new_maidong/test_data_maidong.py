# -*- coding: utf-8 -*-
"""
Created on Mon Aug 03 08:47:44 2015
...
all_time_U.to_csv(os.path.join(outpath,'test_all_time_U.txt'))
all_time_V.to_csv(os.path.join(outpath,'test_all_time_V.txt'))
all_time_chuizhi.to_csv(os.path.join(outpath,'test_all_time_chuizhi.txt'))
...
U_maidong['20130628000000':'20130630000000'].to_csv(os.path.join(outpath,'test_U_maidong.txt'))
V_maidong['20130628000000':'20130630000000'].to_csv(os.path.join(outpath,'test_V_maidong.txt'))
chuizhi_maidong['20130628000000':'20130630000000'].to_csv(os.path.join(outpath,'test_chuizhi_maidong.txt'))