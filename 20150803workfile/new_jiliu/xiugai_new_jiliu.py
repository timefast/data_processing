...
jiliuzhishu_df.to_csv('jiliuzhishu.txt')
...
qiangduzhishu_df.to_csv('qiangduzhishu.txt')
...
di_jiliuzhishu_df.to_csv('di_jiliuzhishu.txt')
gao_jiliuzhishu_df.to_csv('gao_jiliuzhishu.txt')
